...
d3.csv("data/crashes.csv", function(error, data) {
    ...
    svg.selectAll("rect")
        ...
        .on("mouseover", function(d) {
            div.transition()
                .duration(50)
                .style("opacity", .9);
            div.html("<h3>"+ formatTime(d.date) + "</h3>" + "<br/>" +"<p>Revenue: " +  "<strong>"+ d.revenue + "</strong>"+"</p>")
    ...
    function mousemove() {
        ...
        //move focus around
        focus.attr("transform", "translate(" + x(d.date) + "," + y(d.profit) + ")");
        div.transition()
            .duration(50)
            .style("opacity", .9);
        div.html("<h3>"+ formatTime(d.date) + "</h3>" + "<br/>" +"<p>Rate: " + "<strong>"+d.profit + "</strong>" + " profit " + "</p>")
